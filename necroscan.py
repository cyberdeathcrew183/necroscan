...
class FuckBot:
    ...
    def __init__(self):
        ...
        print(Color.RED("         ░    ░  ░░ ░         ░         ░ ░        ░  ░ ░            ░  ░         ░")) 
        print(Color.RED("                  ░                                   ░"))                            
        print(Color.GREEN("WELCOME TO CYBERDEATH BOT LEGION"))
        print(Color.RED("Developed By") + ": " + Color.GREEN("Cyberdeth"))
        print(Color.RED("Contact") + ": " + Color.GREEN("@skab_183"))
        print("\n")
        

        self.show_warning_message(
            message="GUNAKAN DENGAN HATI HATI, AWAS CEPU DI MANA MANA"
        )
        self.show_warning_message(
            message="Developer tidak bertanggung jawab atas kerugian ataupun kerusakan yang menyalah gunakan."
        )
        ...
        table.add_column("Number of Bot")
    ...
    def show_status_message(self, time, counter, length, data = "Data Empty", message = "Message Not Set", status = False, mode = "Default Mode"):
        ...
        status_message += "[%s - %s]" % (Color.CYAN("./Cyberdeth"), Color.YELLOW(mode))
